...
[] Change format so there's entry boxes within the table, making it more similar to the current template.
[] Find a way to make the boxes editable or open ended boxes for entry within the table. 
[]
*/
  ...
  function renderMenuTable() {
    ...
    CATEGORIES.forEach(category => {
      ...
      DAYS.forEach(day => {
        ...
        cell.innerHTML = items.map((item, index) =>
